...
#                  the tests with -DCBK_TEST_LAPACK=openblas and =netlib as
#                  CI does.
...
echo "session-start: the tests validate against LAPACKE; without MKL pick the stack with -DCBK_TEST_LAPACK=openblas|netlib (default: the first found)"
