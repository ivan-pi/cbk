...
|--------|---------|--------|
| `CBK_WITH_MKL` | `OFF` | Build the MKL-style API, the MKL-backed tests, the worked solve example and the benchmarks; requires Intel MKL. The portable example `qr_workflow_compact` builds regardless (given OpenMP). |
