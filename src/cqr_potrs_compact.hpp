/* cqr_potrs_compact.hpp
 *
 * Compact (interleaved-batch) solve A X = B from the Cholesky factorization of
 * cqr_potrf_compact.hpp, templated on scalar type T and interleave width V.
 ...
 * and trsm.
 *
 * Compact storage is as in cqr_potrf_compact.hpp / cqr_trsm_compact.hpp: the
...
#ifndef CQR_POTRS_COMPACT_HPP
#define CQR_POTRS_COMPACT_HPP
